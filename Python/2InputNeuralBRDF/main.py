...
class App(tk.Tk):
    ...
    def _stat_row(self, parent, label):
        ...
        tk.Label(row, text=f"{label}:", fg="gray", width=14, anchor="w").pack(side=tk.LEFT)
    ...
    def _train_thread(self):
        ...
        self.after(0, self._training_done, train_elapsed, epoch_speed, infer_elapsed, inferred_img)
